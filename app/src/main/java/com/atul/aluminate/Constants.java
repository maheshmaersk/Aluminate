...
public class Constants {
   ...
   */
  public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList("US", "GB","INR");
   ...
   */
  public static final String PAYMENT_GATEWAY_TOKENIZATION_NAME = "AmvLabs";
  ...
  public static final HashMap<String, String> PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS =
      new HashMap<String, String>() {{
        ...
        put("gatewayMerchantId", "BCR2DN4TXCUJHLQL");
