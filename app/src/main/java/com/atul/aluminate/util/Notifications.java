...
package com.atul.aluminate.util;
...
import com.atul.aluminate.payments.PaymentTransparentActivity;
import com.atul.aluminate.payments.services.PaymentNotificationIntentService;
  ...
  public static void triggerPaymentNotification(Context context, String selectedOption) {
    ...
    for (String option : options) {
      ...
      if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
        optionColor = res.getColor(R.color.price_button_grey, context.getTheme());
      }
